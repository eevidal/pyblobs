...
// Karl Note:
// I pasted the entire header file in instead of simply including it,
// because I needed to eliminate the overloaded CBlobResult() constructors.
...
//	CBlobResult();	// Karl
	...
	//! Copy constructor
//	CBlobResult( const CBlobResult &source );	// Karl
	//! Destructor
	virtual ~CBlobResult();
